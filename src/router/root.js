...
const constantRouterMap = [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'skimView',
            name: 'skimView',
            component: () => import('/@/views/index/user/skim-view.vue'),
          },
          {
          ...
          },
          {
            path: 'founditemView',
            name: 'founditemView',
            component: () => import('/@/views/index/user/found-thing-edit-view.vue'),
          },
          {
            path: 'thingEditView',
            name: 'thingEditView',
            component: () => import('/@/views/index/user/thing-edit-view.vue'),
          },
          {
            path: 'orderView',
            name: 'orderView',
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'consultation', name: 'consultation', component: () => import('/@/views/admin/consultation.vue') },

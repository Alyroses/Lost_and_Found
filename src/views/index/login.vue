    ...
    <div class="login-page pc-style">
      ...
      <div class="mail-login" type="login">
        ...
        <div class="common-input">
          ...
          <div class="input-view">
            <input placeholder="请输入验证码" v-model="pageData.loginForm.captcha" type="text" class="input" />
            <p class="err-view"> </p>
          </div>
        </div>
...
const captchaImageUrl = ref('http://localhost:8001/myapp/index/user/generateCaptcha'); // 设置验证码生成的 URL


const reloadCaptcha = () => {
  captchaImageUrl.value = 'http://localhost:8001/myapp/index/user/generateCaptcha?${new Date().getTime()}';
};

<template>
      ...
      <div class="tel-regist-page pc-style">
        <div class="regist-header">
          ...
          <div class="regist-title">
            <span class="regist-title-text">绑定账户</span>
  ...
  onMounted(() => {
    ...
    axios.get(`http://localhost:8000/myapp/index/user/oauth_callback?code=${code}`, {
      responseType: 'json',
      ...
      .then(response => {
        if (response.data.code === 0) {
          ...
          location.href = 'http://www.meiduo.site:8008/';
        } else {
          // 用户未绑定

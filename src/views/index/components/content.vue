...
const notices = reactive([
  {
    title: '平台使用总则',
    content: '欢迎使用失物招领平台！请遵守国家法律法规及平台规定，诚信发布信息，共建和谐互助社区。',
  },
  {
    title: '失物发布注意事项',
    content: '发布失物时，请详细描述物品特征、丢失时间、地点等关键信息，并上传清晰照片，以便他人识别。请勿泄露过多个人隐私。',
  },
  {
    title: '拾物发布注意事项',
    content: '拾到他人失物，请及时在本平台发布招领信息。描述物品时应客观准确，并妥善保管拾得物品。鼓励无偿归还或索取合理保管费用。',
  },
  {
    title: '信息核实与安全提示',
    content: '平台会对信息进行初步审核，但请用户自行辨别信息真伪。涉及财物交接时，建议选择公共场所，并注意人身财产安全。',
  },
  {
    title: '积分与奖励机制说明',
    content: '成功帮助他人找回失物或归还拾物将获得平台积分奖励。积极参与平台互动，共建诚信体系。具体积分规则详见用户协议。',
  },
  {
    title: '禁止行为',
    content: '严禁发布虚假信息、诈骗信息、违禁品信息及其他违反法律法规和公序良俗的内容。一经发现，将严肃处理。',
  }
]);
